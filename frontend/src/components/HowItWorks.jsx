...
const steps = [
  {
    ...
    description: 'Sign up in minutes with your business details. Set up your product catalog and pricing structure.',
  },
  {
    icon: UserPlus,
    number: '02',
    title: 'Onboard Your Farmers',
    description: 'Register farmers with instant QR ID card generation. Build your farmer network digitally.',
  },
  {
    icon: ClipboardList,
    number: '03',
    title: 'Log Visits & Sales',
    description: 'Record field visits, credit transactions, and sales. Everything syncs even in low-connectivity areas.',
  },
  {
    icon: BarChart3,
    number: '04',
    title: 'Track Everything',
    description: 'Access real-time dashboards for inventory, credit, analytics, and AI-powered recommendations.',
  },
];
          ...
          <div className="space-y-16 sm:space-y-20">
            {steps.map((step, i) => (
              ...
              >
                ...
                {/* Step number */}
                <span className="font-mono text-xs tracking-[0.2em] uppercase mb-2 block" style={{ color: '#D4A853' }}>
                  Step {step.number}
                </span>

                <h3 className="font-heading text-2xl sm:text-3xl font-medium tracking-tight mb-3" style={{ color: '#1A3C2B' }}>
                  {step.title}
                </h3>

                <p className="font-body text-base leading-relaxed max-w-lg" style={{ color: '#4A5D53' }}>
                  {step.description}
                </p>
              </motion.div>
            ))}
