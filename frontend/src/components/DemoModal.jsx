              ...
              {submitted ? (
                ...
                >
                  <div
                    ...
                    style={{ backgroundColor: "rgba(26, 60, 43, 0.1)" }}
                  >
                  ...
                  <h3
                    ...
                    style={{ color: "#1A3C2B" }}
                  >
                    {copy.demoModal.successTitle}
                  </h3>
                  <p className="font-body text-sm" style={{ color: "#4A5D53" }}>
                    {copy.demoModal.successDescription}
                  </p>
                </motion.div>
              ) : (
                <>
                  <div className="mb-8">
                    <p
                      ...
                      style={{ color: "#D4A853" }}
                    >
                      {copy.demoModal.getStarted}
                    </p>
                    <h3
                      className="font-heading text-2xl sm:text-3xl font-medium"
                      style={{ color: "#1A3C2B" }}
                    >
                      {copy.demoModal.title}
                    </h3>
                    <p
                      className="font-body text-sm mt-2"
                      style={{ color: "#4A5D53" }}
                    >
                      {copy.demoModal.description}
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder={copy.demoModal.placeholders.name}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder={copy.demoModal.placeholders.phone}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder={copy.demoModal.placeholders.email}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder={copy.demoModal.placeholders.message}
                      />
                    </div>
