...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 flex items-end gap-3" data-testid="whatsapp-widget">
      {/* Tooltip */}
      <AnimatePresence>
        {showTooltip && (
          <motion.div
          ...
          >
            ...
            <p className="font-body text-sm font-medium mb-1" style={{ color: '#1A3C2B' }}>
              Chat with us on WhatsApp
            </p>
            <p className="font-body text-xs mb-3" style={{ color: '#4A5D53' }}>
              Get a quick demo or ask any questions about Prithvix.
            </p>
            <a
              href={whatsappUrl}
              target="_blank"
